...
const Room = (props) => {
  const { nodes, materials } = useGLTF("/port/models/optimized-room.glb");
  const screensRef = useRef();
  const matcapTexture = useTexture("/port/images/textures/mat1.png");
...
export default Room;
useGLTF.preload("/port/models/optimized-room.glb");